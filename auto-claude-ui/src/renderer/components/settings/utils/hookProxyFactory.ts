...
export function createHookProxy(
  ...
  return {
    ...
    get showPlaneKey() { return hookRef.current.showPlaneKey; },
    get setShowPlaneKey() { return hookRef.current.setShowPlaneKey; },
    get showPlaneImportModal() { return hookRef.current.showPlaneImportModal; },
    get setShowPlaneImportModal() { return hookRef.current.setShowPlaneImportModal; },
    get planeConnectionStatus() { return hookRef.current.planeConnectionStatus; },
    get isCheckingPlane() { return hookRef.current.isCheckingPlane; },
