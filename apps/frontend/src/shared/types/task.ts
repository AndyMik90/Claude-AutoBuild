...
export interface TaskMetadata {
  // Origin tracking
  sourceType?: 'ideation' | 'manual' | 'imported' | 'insights' | 'roadmap' | 'linear' | 'github' | 'gitlab' | 'forgejo';
  ...
  forgejoIssueNumber?: number;  // Reference to Forgejo issue number if from Forgejo
  forgejoUrl?: string;  // Forgejo issue URL
