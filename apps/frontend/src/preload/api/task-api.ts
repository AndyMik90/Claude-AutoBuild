...
export interface TaskAPI {
  ...
  updateTask: (
    taskId: string,
    updates: { title?: string; description?: string; metadata?: TaskMetadata; dependsOn?: string[] }
  ) => Promise<IPCResult<Task>>;
...
export const createTaskAPI = (): TaskAPI => ({
  ...
  createTask: (
    ...
    ipcRenderer.invoke(IPC_CHANNELS.TASK_CREATE, projectId, title, description, metadata, dependsOn),
