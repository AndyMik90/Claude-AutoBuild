...
import { registerForgejoHandlers } from './forgejo-handlers';
...
export function setupIpcHandlers(
  ...
  // Forgejo integration handlers (self-hosted git instances)
  registerForgejoHandlers(agentManager, getMainWindow);
