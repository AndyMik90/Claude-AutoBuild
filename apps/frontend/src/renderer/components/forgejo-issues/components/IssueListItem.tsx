...
// Forgejo issue state colors and labels
...
const FORGEJO_ISSUE_STATE_LABELS: Record<string, string> = {
  open: 'Open',
  closed: 'Closed'
};
      ...
      <div className="flex items-start gap-3">
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            <Badge
              variant="outline"
              className={`text-xs ${FORGEJO_ISSUE_STATE_COLORS[issue.state] || ''}`}
            >
              {FORGEJO_ISSUE_STATE_LABELS[issue.state] || issue.state}
            </Badge>
