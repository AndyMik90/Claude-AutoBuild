...
export function createHookProxy(
  ...
  return {
    ...
    get showForgejoToken() { return hookRef.current.showForgejoToken; },
    get setShowForgejoToken() { return hookRef.current.setShowForgejoToken; },
    get forgejoConnectionStatus() { return hookRef.current.forgejoConnectionStatus; },
    get isCheckingForgejo() { return hookRef.current.isCheckingForgejo; },
