...
export type SidebarView = 'kanban' | 'terminals' | 'roadmap' | 'context' | 'ideation' | 'github-issues' | 'gitlab-issues' | 'github-prs' | 'gitlab-merge-requests' | 'changelog' | 'insights' | 'worktrees' | 'agent-tools' | 'custom-agents';
...
const baseNavItems: NavItem[] = [
  ...
  { id: 'custom-agents', labelKey: 'Custom Agents', icon: Bot, shortcut: 'O' },
