...
class Blueprint:
    ...
    def from_dict(cls, data: dict) -> 'Blueprint':
        return cls(
            ...
            components=[
                BlueprintComponent.from_dict(c)
...
class BlueprintManager:
    ...
    def get_next_pending(self) -> Optional[BlueprintComponent]:
    ...
    def get_by_id(self, component_id: str) -> Optional[BlueprintComponent]:
        """Get component by ID."""
        for component in self.blueprint.components:
    ...
    def get_by_name(self, name: str) -> Optional[BlueprintComponent]:
    ...
    def get_all_pending(self) -> list[BlueprintComponent]:
        ...
        return [
            c for c in self.blueprint.components
            if c.status == ComponentStatus.PENDING
        ]
    ...
    def reset_component(self, component_id: str) -> bool:
        ...
        component.notes.append(
            f"[{datetime.now().isoformat()}] Reset to pending"
        )
