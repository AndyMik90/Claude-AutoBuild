...
class TokenBudget:
    ...
    def __init__(
        ...
        allocations: Optional[Dict[TokenCategory, int]] = None
    ):
    ...
    def reallocate(self, from_cat: TokenCategory, to_cat: TokenCategory, tokens: int) -> bool:
        """
