...
class CoreModule:
    ...
    master_agent: Optional[AgentPersona] = None
...
class CoreModuleLoader:
    ...
    def __init__(
        ...
        self._module: Optional[CoreModule] = None
    ...
    def _load_agent(self, agent_path: Path) -> Optional[AgentPersona]:
        """
        Load and parse a BMAD agent file.
        """
        cache_key = f"agent:core:bmad-master"
    ...
    def get_master_agent(self) -> Optional[AgentPersona]:
...
"""
    ...
    def get_task_path(self, name: str) -> Optional[Path]:
