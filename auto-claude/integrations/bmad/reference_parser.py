...
class ComponentReferenceParser:
    ...
    def parse(self, user_input: str) -> Optional[object]:
        """
    ...
    def _match_by_id(self, user_input: str) -> Optional[object]:
        """
    ...
    def _find_by_id(self, component_id: str) -> Optional[object]:
    ...
    def _match_by_exact_name(self, user_input: str) -> Optional[object]:
    ...
    def _match_by_keywords(self, user_input: str) -> Optional[object]:
    ...
    def _clean_input(self, text: str) -> str:
        ...
        # Remove common words
        stop_words = {
            'the', 'a', 'an', 'fix', 'update', 'modify', 'change',
            'component', 'module', 'section', 'part', 'area',
            'please', 'can', 'you', 'help', 'with', 'me',
        }
